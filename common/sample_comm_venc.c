...
//                       stH264Cbr.u32BitRate = 512;
                       stH264Cbr.u32BitRate = 40;
                       break;
                    case PIC_D1:
                    case PIC_VGA:	   /* 640 * 480 */
//                       stH264Cbr.u32BitRate = 768;
                       stH264Cbr.u32BitRate = 180;
                       break;
                    case PIC_HD720:   /* 1280 * 720 */
//                       stH264Cbr.u32BitRate = 1024*2;
                    	stH264Cbr.u32BitRate = 700;
                       break;
...
//                	   stH264Vbr.u32MaxBitRate = 512*3;
                	   stH264Vbr.u32MaxBitRate = 40;
                       break;
                  case PIC_D1:
                  case PIC_VGA:	   /* 640 * 480 */
//                	   stH264Vbr.u32MaxBitRate = 1024*2*3;
                	   stH264Vbr.u32MaxBitRate = 180;
                       break;
                  case PIC_HD720:   /* 1280 * 720 */
//                	   stH264Vbr.u32MaxBitRate = 1024*3*3;
                	   stH264Vbr.u32MaxBitRate = 700;
                	   break;
                  case PIC_HD1080:  /* 1920 * 1080 */
...
//                    SAMPLE_PRT("HI_MPI_VENC_Query done\n");
...
//                    SAMPLE_PRT("HI_MPI_VENC_GetStream done\n");
...
//                    SAMPLE_PRT("SAMPLE_COMM_VENC_SaveStream done\n");
...
//                    SAMPLE_PRT("HI_MPI_VENC_ReleaseStream done\n");

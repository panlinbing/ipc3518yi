...
static HI_S32 SAMPLE_Acodec_CfgAudio(AUDIO_SAMPLE_RATE_E enSample, HI_BOOL bMicIn)
{
    ...
    {
        printf("%s: set ACODEC_SET_ADCL_VOL failed\n", __FUNCTION__);
        close(fdAcodec);
        return HI_FAILURE;
    }
    vol_ctrl.vol_ctrl = 6;
    ...
    {
        printf("%s: set ACODEC_SET_ADCR_VOL failed\n", __FUNCTION__);
        close(fdAcodec);
        return HI_FAILURE;
    }

    vol_ctrl.vol_ctrl = 24;
    ...
    vol_ctrl.vol_ctrl = 127;
    if (ioctl(fdAcodec, ACODEC_SET_ADCR_VOL, &vol_ctrl))
    {
        printf("%s: set ACODEC_SET_ADCR_VOL failed - %d\n", __FUNCTION__, fdAcodec);
        close(fdAcodec);
        return HI_FAILURE;
    }
    ...
    //Config GPIO 4 - 1 as output
    HI_U32 value, addr = 0x20180400;
    HI_S32 rc;
...
//    unsigned int ret = -1;
//    if (!ioctl(fdAcodec, ACODEC_GET_GAIN_MICL, &ret)) printf("%s: ACODEC_GET_GAIN_MICL: %d\n", __FUNCTION__, ret);
//    if (!ioctl(fdAcodec, ACODEC_GET_GAIN_MICR, &ret)) printf("%s: ACODEC_GET_GAIN_MICR: %d\n", __FUNCTION__, ret);
//    if (!ioctl(fdAcodec, ACODEC_GET_DACL_VOL, &ret)) printf("%s: ACODEC_GET_DACL_VOL: %d\n", __FUNCTION__, ret);
//    if (!ioctl(fdAcodec, ACODEC_GET_DACR_VOL, &ret)) printf("%s: ACODEC_GET_DACR_VOL: %d\n", __FUNCTION__, ret);
//    if (!ioctl(fdAcodec, ACODEC_GET_ADCL_VOL, &ret)) printf("%s: ACODEC_GET_ADCL_VOL: %d\n", __FUNCTION__, ret);
//    if (!ioctl(fdAcodec, ACODEC_GET_ADCR_VOL, &ret)) printf("%s: ACODEC_GET_ADCR_VOL: %d\n", __FUNCTION__, ret);
